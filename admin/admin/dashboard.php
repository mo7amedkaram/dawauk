...
// إجمالي عمليات البحث
$totalSearches = $db->fetchOne("SELECT SUM(count) as total FROM search_stats")['total'] ?? 0;
// متوسط السعر
...
$topSearchTerms = $db->fetchAll("SELECT search_term, count, last_search_date FROM search_stats ORDER BY count DESC LIMIT 10");
